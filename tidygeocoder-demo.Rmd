...
Reference: https://www.linkedin.com/pulse/plot-over-openstreetmap-ggplot2-abel-tortosa-andreu/

Pull OSM map data for DC. Use coordinates pulled from the OSM map web gui
```{r,warning=F,message=F}
